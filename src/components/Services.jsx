...
function Services() {
  ...
  return (
    ...
    <a className="text-gray-600 font-semibold" href="#">Eat-Yummy</a>
    <br />
    <span>Contact Us : </span>
    <a className="text-gray-600 font-semibold" href="#">123456789</a>
    <br />
    <span>Feel free to mail us at : </span>
    <a className="text-gray-600 font-semibold" href="#">eatyummy@gmail.com</a>
  </div>
        </footer>
    </div>
